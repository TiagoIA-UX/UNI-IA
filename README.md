...
**Primeira vez?** Veja o [Guia Completo de Instalação](./INSTALLATION.md).
...
Referência completa: [AGENTES_GUARDIAO.md](./AGENTES_GUARDIAO.md)
...
1. Pipeline interrompe o fluxo operacional (Mandato Zero Bug)
2. Alerta disparado via Telegram para o canal administrativo
3. Estado registrado em `uni_ia_operational_audit` com `event_type = 'llm_failure'`
4. Operações pendentes aguardam na fila até restabelecimento
...
Integração com provedor LLM alternativo rastreada em: [ForgeOps-AI](https://github.com/TiagoIA-UX/ForgeOps-AI)
...
|---------|-----------|-----------|
| [INSTALLATION.md](./INSTALLATION.md) | Iniciantes | Primeira instalação |
| [AGENTES_GUARDIAO.md](./AGENTES_GUARDIAO.md) | Todos | Entender o conselho |
| [README.md](./README.md) | Devs experientes | Arquitetura geral |
| [schema.sql](./schema.sql) | DBAs | Customizar banco |
...
Boitatá IA é um sistema de suporte à decisão de investimentos. Não é recomendação de investimento. Operações em mercados financeiros envolvem risco de perda de capital. O uso é de responsabilidade exclusiva do operador. Leia o [INSTALLATION.md](./INSTALLATION.md) antes de operar com capital real. BACEN Res. 519/2025 · CVM Res. 30 · LGPD 13.709/2018.
