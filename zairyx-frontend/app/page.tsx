    ...
    <div className={styles.root}>
      ...
      <section className={styles.realtimeSection}>
        <div className={styles.realtimeCard}>
          <h3 className={styles.realtimeTitle}>{t.realtimeTitle}</h3>
          <p className={styles.realtimeBody}>{t.realtimeBody}</p>
        </div>
      </section>

      <section className={styles.twoColSection}>
        <div className={styles.twoColCard}>
          <h3 className={styles.twoColTitle}>{t.govTitle}</h3>
          <p className={styles.twoColBody}>{t.govBody}</p>
          <p className={styles.twoColBodyAlt}>{t.govBodyAlt}</p>
        </div>
